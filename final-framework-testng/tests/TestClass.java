...
{ 
	...
	@Test	
		...
		driver.findElement(By.id("registration_firstname")).sendKeys("Abhay1");
		driver.findElement(By.id("registration_lastname")).sendKeys("KKR1");
		driver.findElement(By.id("registration_email")).sendKeys("testkabhay@gmail.com");
		driver.findElement(By.id("username")).sendKeys("AbhayTest1");
